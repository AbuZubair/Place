...
-- Dumping structure for table masakindo.districts
...
-- Dumping data for table masakindo.districts: ~7.377 rows (approximately)
...
-- Dumping structure for table masakindo.provinces
...
-- Dumping data for table masakindo.provinces: ~34 rows (approximately)
...
-- Dumping structure for table masakindo.regencies
...
-- Dumping data for table masakindo.regencies: ~514 rows (approximately)
